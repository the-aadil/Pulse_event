  ...
  return (
    <section className="relative overflow-hidden bg-ink text-cream">
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-4 pb-20 pt-16 text-center sm:px-6 sm:pb-28 sm:pt-20 lg:px-8">
        <Reveal variant="up" className="inline-flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold-300">
        ...
        <Reveal variant="up" delay={100}>
          <h1 className="font-display mt-8 text-4xl font-semibold leading-[1.08] tracking-tight sm:text-5xl lg:text-7xl">
