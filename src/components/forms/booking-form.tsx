  ...
  return (
    <>
      ...
      <form action={formAction} noValidate className="space-y-6">
        ...
        {/* Style prefill notice */}
        {initialStyle && (
          <div className="flex items-start gap-2.5 rounded-xl border border-gold-300/60 bg-gold-50 px-4 py-3 text-sm text-gold-800">
        ...
        <fieldset className="space-y-5">
          <legend className="text-xs font-bold uppercase tracking-[0.2em] text-gold-600 pb-2 border-b border-gold-100 w-full">
            Contact Details
          </legend>
        ...
        {success && (
          <div
            role="status"
            className="flex items-start gap-2.5 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm"
          >
